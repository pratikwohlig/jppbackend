<div class="row">
<div class="col s12">
<h4 class="pad-left-15">Createachievment</h4>
</div>
<form class='col s12' method='post' action='<?php echo site_url("site/createachievmentsubmit");?>' enctype= 'multipart/form-data'>
    ...
    <div class="row saveclick createbuttonplacement">
        <div class="col m12 s12">
            ...
            <a href="<?php echo site_url("site/viewachievment?id=").$this->input->get("id"); ?>" class="waves-effect waves-light btn red">Cancel</a>
        </div>
    </div>
