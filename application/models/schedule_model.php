...
{
public function create($stadium,$team1,$team2,$bookticket,$timestamp)
{
$data=array("stadium" => $stadium,"team1" => $team1,"team2" => $team2,"bookticket" => $bookticket,"timestamp" => $timestamp);
...
public function edit($id,$stadium,$team1,$team2,$bookticket,$timestamp)
{
if($image=="")
{
$image=$this->schedule_model->getimagebyid($id);
$image=$image->image;
}
$data=array("stadium" => $stadium,"team1" => $team1,"team2" => $team2,"bookticket" => $bookticket,"timestamp" => $timestamp);
$this->db->where( "id", $id );
