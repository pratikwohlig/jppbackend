<div class="row">
    <div class="col s12">
        <h4 class="pad-left-15 capitalize">Create guesswho</h4>
    </div>
    <form class='col s12' method='post' action='<?php echo site_url("site/createguesswhosubmit");?>' enctype= 'multipart/form-data'>
        ...
        <div class="row">
            ...
            padding-top: 30px;">663px X 689px </span>
        </div>
