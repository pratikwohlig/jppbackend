<div class="row">
    <div class="col s12">
        <h4 class="pad-left-15">Edit career</h4>
    </div>
</div>
<div class="row">
    <form class='col s12' method='post' action='<?php echo site_url("site/editcareersubmit"); ?>' enctype='multipart/form-data'>
        ...
        <div class="row saveclick createbuttonplacement">
		  <div class="col m12 s12">
			...
			<a href="<?php echo site_url("site/viewcareer?id=").$this->input->get("playerid");?>" class="waves-effect waves-light btn red">Cancel</a>
		  </div>
		</div>
    </form>
</div>
